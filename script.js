...
const apps = [
    ...
    },
    {
        ...
        name: "Metronome",
        category: "Utility",
        developer: "levinriegner.com",
        youtubeId: "J26PgJ7whRc",
        description: "A wearable tempo display for musicians, built for the Meta Ray-Ban Display glasses.<br><br>Learn more: <a href='https://www.levinriegner.com/work/metronome/' target='_blank' style='color:#0055cc; text-decoration:underline;'>levinriegner.com</a>",
        link: "https://facebook.com/fb_viewapp/web_app_deep_link?appName=Metronome&appUrl=https%3A%2F%2Frbm-demos.lnr.io%2Fmetronome%2F"
    }
];
...
function openAppModal(app) {
    ...
    modalAppDesc.innerHTML = app.description;
